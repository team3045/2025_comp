...
public class GremlinPathfindingCommand extends Command {
  ...
  public GremlinPathfindingCommand(
    ...
    this.originalTargetPose =
        new Pose2d(this.targetPose.get().getTranslation(), this.targetPose.get().getRotation());
  ...
  public boolean isFinished() {
    ...
    if (targetPath != null && !targetPath.isChoreoPath()) {
      ...
      return currentPose.getTranslation().getDistance(targetPose.get().getTranslation())
          <= stoppingDistance;
    }
