...
public class GremlinAutoBuilder {
  ...
  public static void configureCustom(
    ...
    GremlinAutoBuilder.pathFollowingCommandBuilder = pathFollowingCommandBuilder;
    GremlinAutoBuilder.poseSupplier = poseSupplier;
    GremlinAutoBuilder.resetPose = resetPose;
    GremlinAutoBuilder.configured = true;
    GremlinAutoBuilder.shouldFlipPath = shouldFlipPose;
    GremlinAutoBuilder.isHolonomic = isHolonomic;

    GremlinAutoBuilder.pathfindingConfigured = false;
  }
  ...
  /**
   * Returns whether the GremlinAutoBuilder has been configured.
   *
   * @return true if the GremlinAutoBuilder has been configured, false otherwise
   */
  ...
  public static SendableChooser<Command> buildAutoChooserWithOptionsModifier(
      ...
      Function<Stream<PathPlannerAuto>, Stream<PathPlannerAuto>> optionsModifier) {
    if (!GremlinAutoBuilder.isConfigured()) {
      throw new RuntimeException(
          "GremlinAutoBuilder was not configured before attempting to build an auto chooser");
    }
  ...
  /**
   * Get if GremlinAutoBuilder was configured for a holonomic drive train
   *
   * @return True if holonomic
   */
  public static boolean isHolonomic() {
    if (!GremlinAutoBuilder.isConfigured()) {
      throw new RuntimeException("GremlinAutoBuilder was not configured before use");
    }
