 ...
 */
public class DriveToPoseV3 extends Command {
    ...
    public DriveToPoseV3(CommandSwerveDrivetrain driveSubsystem, Supplier<SwerveDriveState> stateSupplier, Supplier<Pose2d> targetPoseSupplier) {
